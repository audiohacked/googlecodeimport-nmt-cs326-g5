 ...
 */
bool wxMozillaBrowser::OpenStream(const wxString &WXUNUSED(location), const wxString &WXUNUSED(type))
{
 ...
 * 	True on success, False on failure
 */
bool wxMozillaBrowser::AppendToStream(const wxString &WXUNUSED(data))
{
