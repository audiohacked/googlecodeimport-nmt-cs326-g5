...
void wxMozillaWindow::GoClicked(wxCommandEvent &WXUNUSED(myEvent))
{
...
void wxMozillaWindow::SaveClicked(wxCommandEvent &WXUNUSED(myEvent))
{
	wxFileDialog mydialog(this, _("Save file as..."), wxEmptyString,Mozilla->GetTitle(),_T("HTML Files (htm,html)|*.htm,*.html"), wxSAVE|wxOVERWRITE_PROMPT);
...
void wxMozillaWindow::MakeEditable(wxCommandEvent &WXUNUSED(myEvent))
{
...
void wxMozillaWindow::SelectAll(wxCommandEvent &WXUNUSED(myEvent))
{
	Mozilla->SelectAll();
}

void wxMozillaWindow::SelectNone(wxCommandEvent &WXUNUSED(myEvent))
{
	Mozilla->SelectNone();
}
